...
const actions={
    searchPolicyTrend({commit},payload){
        axios.get('/secure_event/autoManuPolicyCountTrend.json',{
            params: payload,
            timeout: 600000,
            headers: {'X-Requested-With': 'XMLHttpRequest','Content-Type': 'application/x-www-form-urlencoded'},
            responseType: 'json'
        })
            .then(response=>{commit('doAutoManuPolicyCountTrend',response.data)})
...
const mutations={
    doAutoManuPolicyCountTrend(state,data){
...
export default modulePolicyEventCount;
