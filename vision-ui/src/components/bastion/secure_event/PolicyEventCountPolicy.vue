<template>
    <div>
        ...
        <div id="policy_event_count_policy" class="count_graph"></div>
    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            dataLoad() {
                var dom = document.getElementById("policy_event_count_policy");
                this.myChart = echarts.init(dom);
                this.option = this.$store.state.policy_event_count_policy.option;
                this.pickerOptions=this.$store.state.policy_event_count_policy.pickerOptions;
                this.refresh();
            },
            onSubmit(formName){
                this.option.series=[];
                ...
                this.$store.state.policy_event_count_policy.nameValueMaplist=[];
            ...
            watchResult(){
                this.nameValueMaplist=this.$store.state.policy_event_count_policy.nameValueMaplist;
                var hasData=false;
